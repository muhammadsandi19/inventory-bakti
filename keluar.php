                                ...
                                <table id="datatablesSimple">
                                    ...
                                    if(isset($_POST['filter_tgl'])) {
                                        ...
                                        if($mulai!=null || $selesai!=null) {
                                            $ambilsemuadatabarang = mysqli_query($conn, "select * from keluar k, barang s where s.idbarang = k.idbarang 
                                            and tanggalkeluar BETWEEN '$mulai' and '$selesai'");
                                        ...
                                        <div class="modal fade" id="edit<?=$idb;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <br>
                                                    <input type="date" name="tanggalkeluar" value="<?=$tanggalkeluar;?>" class="form-control" required>
                                                    <br>
                                        ...
                                        <div class="modal fade" id="delete<?=$idb;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <input type="hidden" name="idb" value="<?=$idb;?>">
                                                    <input type="hidden" name="idk" value="<?=$idk;?>">
                                                    <input type="hidden" name="qty" value="<?=$jumlahkeluar;?>">
                                                    <br>
                                                    <br>
