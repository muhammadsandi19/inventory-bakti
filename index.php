                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_POST['filter_tgl'])) {
                                            ...
                                            if($mulai!=null || $selesai!=null) {
                                                ...
                                                INNER JOIN masuk ON barang.idbarang = masuk.idbarang 
                                        ...
                                        <div class="modal fade" id="edit<?=$idb;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <br>
                                                    <input type="number" name="barangkeluar" value="<?=$barangkeluar;?>" class="form-control" required>
                                                    <br>
                                                    <input type="number" name="stockakhir" value="<?=$stockakhir;?>" class="form-control" required>
                                                    <br>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <br>
                <input type="number" name="barangkeluar" placeholder="Barang Keluar" class="form-control" required>
                <br>
                <input type="number" name="stockakhir" placeholder="Stock Akhir" class="form-control" required>
                <br>
